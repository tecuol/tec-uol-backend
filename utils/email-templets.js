...
exports.generateHTMLResponse = generateHTMLResponse;
function generateWelcomeEmail(guestName) {
    return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
function generateEventInvitation(data) {
...
function generateParticipationConfirmation(data) {
...
function generateInnovationFundingResponse(data) {
...
function generateContactFormHTML(data) {
    ...
    const currentDateTimeIST = (0, TECUOLLib_1.getCurrentDateTimeIST)();
    return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
