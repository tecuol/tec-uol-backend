    ...
    getList(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield (0, TECUOLLib_1.getDataList)(req, res, participants_model_1.default, search);
            }
            catch (error) {
    ...
    save(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield (0, TECUOLLib_1.saveIfNotExist)({
                    req,
                    model: organization_model_1.default,
                    getKey: 'organization'
                });
...
ParticipantController.selfInstance = null;
exports.default = ParticipantController.getInstance();
const getParticipants = (id_string) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!id_string) {
            return null;
        }
        id_string = id_string.split(",");
        return yield participants_model_1.default.findAll({
            where: {
                id: id_string
            }
        });
