    ...
    getList(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield (0, TECUOLLib_1.getDataList)(req, res, participant_type_model_1.default, search);
            }
            catch (error) {
...
ParticipantTypeController.selfInstance = null;
exports.default = ParticipantTypeController.getInstance();
